...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2025 at 04:33 PM
...
INSERT INTO `verification_tokens` (`id`, `user_id`, `token`, `created_at`) VALUES
(19, 8, 'db05720aeea6228acf7922cd295484b8f9d5e34ef9ef308768daaf4c5a4d5295cb9706dc1cb97ed0a21469b87b57974a67e3', '2025-03-09 14:39:29');
...
--
ALTER TABLE `order_item`
  MODIFY `orderedItem_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
...
--
ALTER TABLE `product_quantity_updates`
  MODIFY `Update_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=361;
...
--
ALTER TABLE `sub_category`
  MODIFY `SubCategory_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
...
--
ALTER TABLE `user_account_switch`
  MODIFY `Switch_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
