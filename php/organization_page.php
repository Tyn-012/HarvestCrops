            ...
            <div class="section" >
                <div class="row d-flex justify-content-center align-items-center p-1" >
                    ...
                    <div class="col-md-8 d-flex justify-content-end align-items-center">                       
                        <a class="anc-page px-3 c-cfe1b9" href="organization_page.php">My Account</a>
                    ...
                    <div class="row py-5 d-flex justify-content-center align-items-center">
                        <div class="col-md-4 mb-5">
                            <div class="col-md-12 pb-2">
                                <div class="section d-flex justify-content-center align-items-center">
                                    <img src="../images/temp_icon.jpg" class="bg-light rounded-circle shadow" height="150px" width="150px" alt=""><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 d-flex justify-content-center align-items-center">
                                <p class="rounded p-2">Organization</p>
                            </div>
                        </div>
                        <div class="col-md-8 mb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a class="btn btn-md bg-1e5915 c-e9ffff my-4 py-2" href="account_info_update.php">Modify Personal Account Details</a>
                                    </div>
                                    <div class="col-md-12">
                                        <a class="btn btn-md bg-1e5915 c-e9ffff my-4 py-2" href="organization_details_update.php">Modify Organization Information</a>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-1E5915 p-1 rounded mb-4 me-3 mt-4"></div>
                            <h4 class="c-2E4F21">Notice Creation</h4>
                            <div class="col-md-12">
                                <a class="btn btn-md bg-1e5915 c-e9ffff my-4 py-2" href="notice_creation_page.php">Create Notice</a>
                            </div>
                        </div>
                    </div>
                </div>
