<!--CONSIDERED AS THE BUYER / RENAMED (Vendor)-->
<?php
...
<head>
    ...
    <title>HarvestCrops - Vendor Account Page</title>
</head>
            ...
            <div class="section" >
                <div class="row d-flex justify-content-center align-items-center p-1" >
                    ...
                    <div class="col-md-8 d-flex justify-content-end align-items-center">                       
                        <a class="anc-page px-3 c-cfe1b9" href="farmer_account_page.php">My Account</a>
                        ...
                        <div class="col-md-8 mb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-md bg-1e5915 c-e9ffff my-4 py-1" href="farmer_details_update.php">Modify Vendor Information</a>
                                    </div>
                                </div>
                            </div>
