            ...
            <div class="container">
                <div class="section bg-cfe1b9 rounded-4 mb-4">
                    <div class="row p-4 m-4 d-flex justify-content-start align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="HomeAdd" class="form-control mb-2"
                            placeholder="Home Address" required autofocus>
                        </div>
                        <div class="col-md-5 mt-2">
                            <input class="address-inp-ds form-control" name="IslandGroup" id="Island" placeholder="Island Group" required>
                        </div>
                        <div class="col-md-5 mt-2">
                            <input class="address-inp-ds form-control" name="City" id="City" placeholder="City" required>
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="ZIP" class="mt-3 form-control mb-2"
                            placeholder="ZIP Code" required autofocus>
                        </div>
                        <div class="col-md-5">
                            <input class="address-inp-ds form-control" name="Region" id="Region" placeholder="Region" required>
                        </div>
                        <div class="col-md-5">
                            <input class="address-inp-ds form-control" name="Barangay" id="Barangay" placeholder="Barangay" required>
                        </div>
