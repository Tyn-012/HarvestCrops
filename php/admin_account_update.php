...
if ($row = $result->fetch_assoc()) {
    ...
    $emailadd = $row['User_EmailAddress'];
...
<body class="admin_update_bg">
    <section class="mt-5 pt-5">
        <form class="rounded" action="components/account_updates.php" method="post">
            <div class="container">
                <div class="section bg-cfe1b9 mb-4 rounded-4 shadow">
                    <div class="row p-4 m-4 d-flex justify-content-start align-items-center">
                        ...
                        <h1 class="h3 mb-3 d-flex justify-content-center mb-5 c-2E4F21">Update User Account</h1>
                        ...
                        <div class="col-md-4">
                            ...
                            placeholder="Email Address" value="<?php echo $emailadd; ?>" required autofocus>
                        </div>
                        <div class="col-md-4">
