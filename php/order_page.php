            ...
            <div class="section" >
                <div class="row d-flex justify-content-center align-items-center p-1" >
                    ...
                    <div class="col-md-8 d-flex justify-content-end align-items-center">                       
                        ...
                        <a class="anc-page px-3 c-cfe1b9" href="order_page.php">Orders</a>
    ...
    <div class="container-fluid mb-5 mt-2">
        <div class="row flex-nowrap">
            <div class="col py-5">
                <div class="container">
                    <div class="section">
                        <div class="row text-light bg-1E5915 pt-2 py-1 mb-2 ps-2 rounded hide_header shadow ">
                                        ...
                                        <div class="col-md-5 d-flex justify-content-center p-4">
                                            <span>
                                                <form action="components/product_status_update.php" method="post">
                                                    ...
                                                    <button name="accept" class="btn btn-sm bg-1e5915 c-e9ffff mx-2">Accept</button>
                                                    <button name="complete" class="btn btn-sm bg-1e5915 c-e9ffff mx-2">Complete</button>
                                                </form>
                                            </span>
                                        </div>
                                    </div>';
