                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">   
                                <a href="user_notice.php" class="d-flex align-items-center justify-content-center pb-3 mb-md-0 me-md-auto text-decoration-none">
                                    <span class="fs-5 d-none d-sm-inline text-dark">Notices</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        <div class="row">
                            ...
                            <div class="col-md-6 p-2 m-2 mx-4">
                                ...
                                <a class="btn btn-md bg-dark text-light my-4 py-2" href="vendor_details_update.php">Modify Vendor Information</a>
                            </div>
                            <div class="col-md-5">
                                <div class="row">
                                    <!--
